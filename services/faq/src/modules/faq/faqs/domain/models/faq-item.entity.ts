export class FaqItem {
  ...
  get targetRole(): string { return this._targetRole; }
  get order(): number { return this._order; }
  get active(): boolean { return this._active; }
  get viewCount(): number { return this._viewCount; }
  get createdAt(): Date | undefined { return this._createdAt; }

  withQuestion(v: string) { this._question = v; return this; }
  withAnswer(v: string) { this._answer = v; return this; }
  withCategory(v: string) { this._category = v; return this; }
  withTargetRole(v: string) { this._targetRole = v; return this; }
  withOrder(v: number) { this._order = v; return this; }
