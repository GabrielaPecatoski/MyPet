...
test('selecionar Veterinário ativa "Continuar como Veterinário"', async ({
  page,
}) => {
  await chegaNaWelcome(page);
...
test('selecionar Motorista ativa "Continuar como Motorista"', async ({
  page,
}) => {
  await chegaNaWelcome(page);
...
test("Continuar como Tutor abre o cadastro com tipo Tutor pré-selecionado", async ({
  page,
}) => {
  await chegaNaWelcome(page);
  await tapText(page, "Sou Tutor");
...
test("Continuar como Veterinário abre o cadastro com seção CRMV", async ({
  page,
}) => {
  await chegaNaWelcome(page);
  await tapText(page, "Sou Veterinário");
...
test("Continuar como Motorista abre o cadastro com seção de veículo", async ({
  page,
}) => {
  await chegaNaWelcome(page);
  await tapText(page, "Sou Motorista");
