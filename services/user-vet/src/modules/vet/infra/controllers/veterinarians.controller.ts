...
export class VeterinariansController {
  ...
  createEmergencyCall(@Param('vetId') vetId: string, @Body() dto: CreateEmergencyCallDto) {
  ...
  associate(@Param('id') id: string, @Param('establishmentId') establishmentId: string) {
  ...
  updateAvailability(@Param('id') id: string, @Body() dto: UpdateVetAvailabilityDto) {
