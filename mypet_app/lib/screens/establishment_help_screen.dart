...
class _Chip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: selected ? AppColors.estab : Colors.white,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
                color: selected ? AppColors.estab : AppColors.greyLight),
          ),
          child: Text(label,
              style: TextStyle(
                  fontSize: 12,
...
class _Banner extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border:
              Border.all(color: AppColors.estab.withValues(alpha: 0.3)),
        ),
        child: Row(
          children: [
            Container(
